...
void MakePrism()
{
	...
	double H[] = { -8,0,0 };
	double Hh[] = { -8,0,10 };
	double P_center[] = { 4.5, 5, 0 };
	double P_centerh[] = { 4.5, 5, 10 };
	double dy = B[1] - C[1];
	double dx = B[0] - C[0];
	double deg2 = atan2(dy, dx) * 180 / M_PI + 167.35;
...
void Render(OpenGL* ogl)
{
   ...
   //Сообщение вверху экрана
	...
	ss << "G - дв}игать свет по горизонтали" << std::endl;
